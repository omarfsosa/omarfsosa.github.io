...
Let’s write the above model as a potential function. Remember, the potential energy is just the negative of the joint log-density. I will first write a quick, dirty implementation and I’ll later refine it into something that is easier to generalize.
