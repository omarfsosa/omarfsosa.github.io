...
<img style="display:block; width:50%; height:auto; margin:auto;" src="/assets/images/blog-images/2020-05-26-bayes/dataset.png" />
...
![Stan](/assets/images/blog-images/2020-05-26-bayes/stan.png)
...
sm = pystan.StanModel(file=“my_model.stan”)  # Compile the model, might take a couple of minutes
data = {
    “N”: len(X),
    “X”: X,
    “y”: y,
...
samples = sm.sampling(data) # Run the MCMC sampler
print(samples)
```
...
```python
import seaborn
seaborn.jointplot(*samples[“w”].T, kind=“kde”)
```
<img style="display:block; width:50%; height:auto; margin:auto;" src="/assets/images/blog-images/2020-05-26-bayes/joint.png" />
...
plt.contourf(*meshgrid, y_probas.mean(axis=0))
plt.show()
```
<img style="display:block; width:50%; height:auto; margin:auto;" src="/assets/images/blog-images/2020-05-26-bayes/logit_mean.png" />
...
```python
plt.contourf(*meshgrid, y_probas.std(axis=0))
plt.show()
```

<img style="display:block; width:50%; height:auto; margin:auto;" src="/assets/images/blog-images/2020-05-26-bayes/logit_std.png" />
